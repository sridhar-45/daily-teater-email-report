...
def excel_to_pivot(result_df, combined_df):
    ...
    start_date = yesterday.strftime('%d-%m-%Y 08:00 AM')
    end_date = today.strftime('%d-%m-%Y 08:00 AM')

    # ✅ Convert DataFrame to HTML table with elegant style
    ...
    <body>
    <h2>📊 Daily TEATER Usage Summary</h2>
    <p style="font-size:15px; text-align:left;">
        Hi Sir,<br><br>
        Please find below the latest <b>feature utility pivot table</b> and <b>chart update</b> from Google Sheets.<br>
        This data represents the usage from <b>{start_date}</b> to <b>{end_date}</b>.<br><br>
        Kindly review the summary below.
    </p>
    {styled_html}
    <p class="footer">
        <b>Generated Date:</b> {today.strftime('%d-%m-%Y %I:%M %p')}<br>
        ✅ This report was automatically generated by the <b>TEATER Analytics System</b>.
    </p>
    </body>
    </html>
    """
